...
public class NIOFilesDemo {
    public static void main(String[] args) throws IOException {
    	...
    	// TODO: this is not yet supported because of local variable problems in the generated bytecode...
    	@SuppressWarnings({ "resource", "unused" })
    	DirectoryStream<Path> dirStream = Files.newDirectoryStream(Paths.get("."));
    	dirStream.close();

    	@SuppressWarnings({ "resource", "unused" })
    	DirectoryStream<Path> dirStream2 = Files.newDirectoryStream(Paths.get("."), "*");
    	dirStream2.close();
