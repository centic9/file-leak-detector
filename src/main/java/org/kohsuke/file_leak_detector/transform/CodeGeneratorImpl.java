 ...
 */
public class CodeGeneratorImpl extends MethodVisitor implements CodeGenerator {
    public CodeGeneratorImpl(MethodVisitor mv) {
        super(ASM5,mv);
    }
    ...
    /* (non-Javadoc)
	 * @see org.kohsuke.file_leak_detector.transform.CodeGenerator#invokeVirtual(java.lang.String, java.lang.String, java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see org.kohsuke.file_leak_detector.transform.CodeGenerator#invokeAppStatic(java.lang.Class, java.lang.String, java.lang.Class[], int[])
	 */
...
//    }
    ...
    /* (non-Javadoc)
	 * @see org.kohsuke.file_leak_detector.transform.CodeGenerator#invokeAppStatic(java.lang.String, java.lang.String, java.lang.Class[], int[])
	 */
    public void invokeAppStatic(String userClassName, String userMethodName, Class[] argTypes, int[] localIndex) {
        Label s = new Label();
        Label e = new Label();
